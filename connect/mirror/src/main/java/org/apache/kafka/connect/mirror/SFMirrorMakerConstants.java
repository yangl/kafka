...
public class SFMirrorMakerConstants {
    ...
    // MM2自动创建topic开关，默认 false
    public static final String MM2_AUTO_CREATE_TOPICS_ENABLED_KEY = "mm2.auto.create.topics.enabled";

    // MM2自动创建分区开关，默认 true
    public static final String MM2_AUTO_CREATE_PARTITIONS_ENABLED_KEY = "mm2.auto.create.partitions.enabled";
